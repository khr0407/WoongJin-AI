...
public class QBCorrectFragment extends AppCompatActivity {
    Intent intent, intent_makebombtype, intent_gamelist;
    private DatabaseReference mPostReference;
    ImageButton send;
    TextView textCheckCorrect;
    String timestamp_key, id_key, nickname_key, user1_key, user2_key, bucketcnt_key, roomname_key, script_key, state_key;

    protected void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.fragment_qbcorrect);

        intent = getIntent();
        intent_makebombtype = new Intent(QBCorrectFragment.this, Quizbucketquiztype.class);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent_gamelist = new Intent(QBCorrectFragment.this, QuizbucketMain.class);
