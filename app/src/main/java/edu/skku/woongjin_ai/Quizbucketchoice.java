...
public class Quizbucketchoice extends AppCompatActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quizbucketchoice);
        ...
        checkButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quiz.length() == 0 || ans.length() == 0 || ans1.length() == 0 || ans2.length() == 0 || ans3.length() == 0 || ans4.length() == 0) {
                    Toast.makeText(Quizbucketchoice.this, "Fill all blanks", Toast.LENGTH_SHORT).show();
                }
                else {
                    postFirebaseDatabaseQuizChoice();
                    Toast.makeText(Quizbucketchoice.this, "출제 완료!", Toast.LENGTH_SHORT).show();
                    intentGameList = new Intent(Quizbucketchoice.this, QuizbucketMain.class);
        ...
        imageHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intentHome = new Intent(Quizbucketchoice.this, MainActivity.class);
            ...
            public void onClick(View v) {
                if (flagA1 == 0 ) {
                    if(flagA2 == 0 && flagA3 == 0 && flagA4 == 0 ){
                        ...
                        Toast.makeText(Quizbucketchoice.this, "먼저 정답을 초기화하세요", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
