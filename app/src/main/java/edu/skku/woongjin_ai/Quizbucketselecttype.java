...
public class Quizbucketselecttype extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quizbucketselecttype);
        ...
        intentReadScript = new Intent(Quizbucketselecttype.this, QuizbucketMain.class);
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intentHome = new Intent(Quizbucketselecttype.this, MainActivity.class);
