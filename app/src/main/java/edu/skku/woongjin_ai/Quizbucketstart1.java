...
public class Quizbucketstart1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButtonHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intentHome = new Intent(Quizbucketstart1.this, MainActivity.class);
        ...
        invitefriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                TextTemplate params = TextTemplate.newBuilder(
                        ...
                        .build();
                KakaoLinkService.getInstance().sendDefault(Quizbucketstart1.this, params, serverCallbackArgs, new ResponseCallback<KakaoLinkResponse>() {
                    @Override
            ...
            public void onClick(View view) {
                ...
                if (check_choose == 1 && check_script == 1) {
                    if (friend_nickname.length() > 0 && spaceCheck(text_roomname) == false && text_roomname.length() > 0) { //create chat room
                        final ValueEventListener checkRoomRegister = new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (editText_roomname.getText().toString().length() > 0 && flag == 0) { //채팅방이 처음 만들어질 경우
                                    ...
                                    Toast.makeText(getApplicationContext(), friend_nickname + "와의 챌린지가 시작되었습니다.", Toast.LENGTH_SHORT).show();
                                    finish();
                                }
                                flag = 0;
                            }
                        ...
                        editText_roomname.setText("");
                        Toast.makeText(Quizbucketstart1.this, "채팅방 이름을 바르게 입력해주세요", Toast.LENGTH_SHORT).show();
                    }
                }
                else if (check_choose == 0){
                    Toast.makeText(Quizbucketstart1.this, "문제를 보낼 친구를 골라주세요", Toast.LENGTH_SHORT).show();
                }
                else if (check_script == 0){
                    Toast.makeText(Quizbucketstart1.this, "문제를 보낼 지문을 골라주세요", Toast.LENGTH_SHORT).show();
                }
                else if (check_choose == 0 && check_script == 0){
                    Toast.makeText(Quizbucketstart1.this, "문제를 보낼 친구와 문제에 쓰일 지문을 골라주세요", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    public void postListDatabase(boolean add) {
        ...
        if(add) {
            FirebasePost_QBlist post = new FirebasePost_QBlist(editText_roomname.getText().toString(), nickname_key, friend_nickname, "none", "none", "none", "bucket0", script_name,"gaming0" );
